...
gcc %CFLAGS% -shared -fno-exceptions src\dll.c src\log.c %MH%\buffer.c %MH%\trampoline.c %MH%\hook.c %MH%\hde\hde32.c src\d3d.cpp -static-libgcc -lkernel32 -ld3d9 -lD3dx9 -o %DLL%
